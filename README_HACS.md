...
```bash
git clone https://github.com/francescogalli-design/homemind-ai.git
cd homemind-ai
cp .env.example .env
...
- Documentazione: [README.md](https://github.com/francescogalli-design/homemind-ai/blob/main/README.md)
